...
class QmkRgblightHandler(BasicHandler):
    ...
    def __init__(self, container):
        ...
        self.lbl_underglow_effect = QLabel(tr("RGBConfigurator", "氛围光效果"))
        ...
        self.lbl_underglow_brightness = QLabel(tr("RGBConfigurator", "氛围灯亮度"))
        ...
        self.lbl_underglow_color = QLabel(tr("RGBConfigurator", "氛围灯颜色"))
...
class VialRGBHandler(BasicHandler):
    ...
    def __init__(self, container):
        ...
        self.lbl_rgb_effect = QLabel(tr("RGBConfigurator", "RGB 效果"))
