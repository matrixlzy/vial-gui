...
class TapDanceEntryUI(QObject):
    ...
    def __init__(self, idx):
        ...
        l.addSpacing(10)
        lbl = QLabel("使用 <code>TD({})</code> 设置按键映射.".format(self.idx))
        l.addWidget(lbl)
    ...
    def populate_container(self):
        ...
        self.container.addWidget(QLabel("On tap + hold(短+长按)"), 3, 0)
        ...
        self.container.addWidget(QLabel("敲击时间(毫秒)"), 4, 0)
...
class TapDance(BasicEditor):
    ...
    def __init__(self):
        ...
        self.btn_revert = QPushButton(tr("TapDance", "还原"))
