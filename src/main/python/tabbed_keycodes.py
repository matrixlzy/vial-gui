...
class FilteredTabbedKeycodes(QTabWidget):
    ...
    def __init__(self, parent=None, keycode_filter=keycode_filter_any):
        ...
        self.tabs = [
            ...
            SimpleTab(self, "Layers(层)", KEYCODES_LAYERS),
            Tab(self, "Quantum(量子按键)", [(mods, (KEYCODES_BOOT + KEYCODES_QUANTUM)),
            ...
            SimpleTab(self, "Tap Dance(指尖舞蹈)", KEYCODES_TAP_DANCE),
